# Generated by Django 2.0 on 2019-07-04 16:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('published', 'Published'), ('partial_payment', 'Partial Payment'), ('paid_in_full', 'Paid in Full')], default='new', max_length=32)),
                ...
                ('pay_to', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='pay_to', to='users.WhitelistAddress')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='payments', to='invoices.Invoice')),
            ],
            options={
                'abstract': False,
            },
